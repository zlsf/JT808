...
public class DownPlatformMsgPostQueryReqHandler implements DownPlatformMsgDataHandler {
	...
	public void handle(DownPlatformMsgData mdata) {
		...
		platformManagerService.ackPostQuery(infoId, info);
	}

	@Override
	public boolean canHandle(int dataType) {
		return JT809Constant.DOWN_PLATFORM_MSG_POST_QUERY_REQ == dataType;
	}
}
