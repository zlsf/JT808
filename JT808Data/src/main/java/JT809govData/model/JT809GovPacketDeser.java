...
public class JT809GovPacketDeser {

    private static final Logger log = LoggerFactory.getLogger(JT809GovPacketDeser.class);

    private long m1;
    private long ia1;
    private long ic1;

    public JT809GovPacketDeser(long m1, long ia1, long ic1) {
	this.m1 = m1;
	this.ia1 = ia1;
	this.ic1 = ic1;
    }
